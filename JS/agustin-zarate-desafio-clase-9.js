...
/*     mazo.splice((firstCard.id - 1), 1)
    ...
    <div class="d-flex justify-content-around row" id="playerCards">
        <div class="col-4">
        <input type="image" src="${playerHand[0].imagen}" id="cardOne" class="btn carta" onclick="selectedCardOne()">
        </div>
        <div class="col-4">
        <input type="image" src="${playerHand[1].imagen}" id="CardTwo" class="btn carta" onclick="selectedCardTwo()">
        </div>
        <div class="col-4">
        <input type="image" src="${playerHand[2].imagen}" id="cardThree" class="btn carta" onclick="selectedCardThree()">
        </div>
    </div>
