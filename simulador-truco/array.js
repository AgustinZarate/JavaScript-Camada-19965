...
mazo.push(new Carta(10, "espada", 0,  10, "../img/10-espada.png", "../img/reverso.png"))
mazo.push(new Carta(11, "espada", 0,  9, "../img/11-espada.png", "../img/reverso.png"))
mazo.push(new Carta(12, "espada", 0,  8, "../img/12-espada.png", "../img/reverso.png"))
//Basto
...
mazo.push(new Carta(10, "basto",0,   10, "../img/10-basto.png", "../img/reverso.png"))
mazo.push(new Carta(11, "basto",0,   9, "../img/11-basto.png", "../img/reverso.png"))
mazo.push(new Carta(12, "basto",0,   8, "../img/12-basto.png", "../img/reverso.png"))
//Oro
...
mazo.push(new Carta(10, "oro", 0, 10, "../img/10-oro.png", "../img/reverso.png"))
mazo.push(new Carta(11, "oro", 0, 9, "../img/11-oro.png", "../img/reverso.png"))
mazo.push(new Carta(12, "oro", 0, 8, "../img/12-oro.png", "../img/reverso.png"))
//Copa
...
mazo.push(new Carta(10, "copa", 0, 10, "../img/10-copa.png", "../img/reverso.png"))
mazo.push(new Carta(11, "copa", 0, 9, "../img/11-copa.png", "../img/reverso.png"))
mazo.push(new Carta(12, "copa", 0, 8, "../img/12-copa.png", "../img/reverso.png"))
